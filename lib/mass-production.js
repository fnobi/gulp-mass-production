...
module.exports = (opts) => {
    ...
    function slugRule (slug, meta) {
        return slug + '.html';
        // return slug + '/index' + path.extname(template);
    }
    ...
    function flush (callback) {
        ...
        const createPostFile = (slug, meta, body='') => {
            const destPath = slugRule(slug, meta);
            const srcPath = destPath.replace(/\.html$/, path.extname(template));

            // TODO: .htmlじゃなかったらindex.htmlを付け足す
